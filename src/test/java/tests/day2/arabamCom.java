...
public class arabamCom {
    ...
    public void setUp() throws MalformedURLException {
        ...
        capabilities.setCapability(MobileCapabilityType.AUTOMATION_NAME, "UiAutomator2");
         capabilities.setCapability(MobileCapabilityType.APP,"C:\\Users\\kantoor\\IdeaProjects\\APPIUM-T116\\Apps\\arabam.com_4.8.0_Apkpure.apk");
    ...
    public void arabamTest() throws InterruptedException {
        ...
        AndroidElement kmBox=driver.findElementByXPath("(//*[@text='Seç'])[1]");
        kmBox.click();
        Thread.sleep(1000);
